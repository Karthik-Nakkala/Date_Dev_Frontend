  ...
  return (
    <div className="group flex items-center justify-between rounded-2xl border border-[#2A2942] bg-[#0D0C19] px-5 py-4 transition-all duration-300 hover:border-violet-500/60 hover:bg-[#111021]">
      ...
      <div className="ml-6 flex shrink-0 items-center gap-3">
        ...
        <button className="flex h-10 items-center gap-2 rounded-xl bg-gradient-to-r from-violet-700 to-fuchsia-500 px-5 text-sm font-semibold text-white transition hover:opacity-90">
        ...
        <button className="flex h-10 items-center gap-2 rounded-xl border border-[#393656] px-5 text-sm font-medium text-zinc-300 transition hover:border-violet-500 hover:text-white">
